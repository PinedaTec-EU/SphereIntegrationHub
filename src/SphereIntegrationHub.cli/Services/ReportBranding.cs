...
internal static class ReportBranding
{
    ...
    internal const string FaviconSvg = """
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
  ...
  <circle cx="60" cy="14" r="5" fill="url(#nodeGrad)"/>
  <circle cx="100" cy="35" r="5" fill="url(#nodeGrad)"/>
  <circle cx="100" cy="85" r="5" fill="url(#nodeGrad)"/>
  <circle cx="60" cy="106" r="5" fill="url(#nodeGrad)"/>
  <circle cx="20" cy="85" r="5" fill="url(#nodeGrad)"/>
  <circle cx="20" cy="35" r="5" fill="url(#nodeGrad)"/>
  <circle cx="60" cy="60" r="22" fill="url(#sphereGrad)"/>
